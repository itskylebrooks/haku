    ...
    >
      <div className="mb-1 mx-4 flex items-center justify-center gap-4 rounded-full border border-gray-200/80 bg-white px-3 py-1.5 shadow-lg dark:border-gray-700/80 dark:bg-black">
        ...
        <button
          ...
          className="inline-flex h-10 items-center justify-center rounded-full bg-gray-200 px-4 text-gray-900 font-semibold shadow-sm transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-400 active:scale-[0.99] dark:bg-gray-200 dark:text-gray-900 dark:focus-visible:outline-gray-500"
        >
