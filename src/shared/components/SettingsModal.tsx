      ...
      >
        <div className="mb-2">
          <div className="relative h-12 flex items-center justify-center">
            <span id="settings-title" className="text-lg font-semibold tracking-wide text-[var(--color-text-primary)]">
              Settings
            </span>
          </div>
        </div>
        ...
        <div className="mt-6 text-center text-[12px] text-[var(--color-text-subtle)] relative">
          ...
          <div className="mt-0.5 flex items-center justify-center gap-3">
            <a href="https://itskylebrooks.vercel.app/imprint" target="_blank" rel="noopener noreferrer" className="underline">
              Imprint
            </a>
            <a href="https://itskylebrooks.vercel.app/privacy" target="_blank" rel="noopener noreferrer" className="underline">
              Privacy Policy
            </a>
            <a href="https://itskylebrooks.vercel.app/license" target="_blank" rel="noopener noreferrer" className="underline">
              License
            </a>
          </div>
        </div>
